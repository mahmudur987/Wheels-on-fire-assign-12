...
const Footer = () => {
    return (
        <div className='bg-cover my-20 h-full backdrop-blur-2xl' style={{ backgroundImage: `url(${img})` }}>
            <footer className="footer p-10 text-lime-50  ">
                <div>
                    ...
                    <Link className=" font-bold text-xl link link-hover">Advertisement</Link>
                </div>
                <div>
                ...
                <div>
                    ...
                    <Link className=" font-bold text-xl link link-hover">Terms of use</Link>
                    <Link className=" font-bold text-xl link link-hover">Privacy policy</Link>
                    <Link className=" font-bold text-xl link link-hover">Cookie policy</Link>
                </div>
            </footer>
            <p className='text-center text-white font-bold'>Copyright © 2022 - All right reserved</p>
        </div>
    );
};
