            ...
            <div className='border border-black p-4'>
                ...
                <form onSubmit={handleSubmit(handleSignUp)}>
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        )} type="file" placeholder="Choose photo" className="input input-bordered w-full max-w-xs" />
                        {errors.name && <p className='text-red-600' role="alert">{errors.photo?.message}</p>}
                    </div>
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        <select {...register("userType",
                            ...
                            <option disabled selected value={'Buyer'} >Buyer</option>
                            <option value={'Buyer'} >Buyer</option>
                            <option value={'Seller'}>Seller</option>
                        </select>

                        {errors.name && <p className='text-red-600' role="alert">{errors.userType?.message}</p>}
                    </div>
                    <div className="form-control w-full max-w-xs">
                        <label className="label">
