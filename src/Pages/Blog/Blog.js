    ...
    return (
        <div>
            ...
            <div className='border-4 border-green-900 p-5 m-5'>
                <h1 className='font-bold text-2xl'>Question .1  :What are the different ways to manage a state in a React application? ? </h1>
                <h1 className=' font-extrabold underline  text-red-600'>Answer</h1>

                <p>
                    The Four Kinds of React State to Manage
                    When we talk about state in our applications, its important to be clear about what types of state actually matter.
            ...
            <div className='border-4 border-green-900 p-5 m-5'>
                <h1 className='font-bold text-2xl'>Question .2  :How does prototypical inheritance work?</h1>
                <h1 className=' font-extrabold underline  text-red-600'>Answer</h1>
            ...
            <div className='border-4 border-green-900 p-5 m-5 gap-5 grid'>
                <h1 className='font-bold text-2xl'>Question .3  : What is a unit test? Why should we write unit tests?</h1>
                <h1 className=' font-extrabold underline  text-red-600'>Answer</h1>
            ...
            <div className='border-4 border-green-900 p-5 m-5 grid gap-6'>
                <h1 className='font-bold text-2xl'>Question .4  :  React vs. Angular vs. Vue? </h1>
                <h1 className=' font-extrabold underline  text-red-600'>Answer</h1>
                <p>
                    <h1 className="text-xl">Angular vs React</h1> <br />

                    If the choice youre making is based on Angular vs React alone, then youll simply need to consider the pros and cons discussed for those libraries in this post. But overall, keep in mind that both libraries can be used for mobile and web apps, while Angular is generally better for more complex apps that are enterprise-ready.
                ...
                <p>
                    ...
                    In most cases, you probably wouldnt be deciding between only Angular and Vue. They are vastly different libraries with very different feature sets and learning curves. Vue is the clear choice for less experienced developers, and Angular would be preferred for those working on larger apps.
                    ...
                    It should also be noted that Vue was created by a developer who formerly worked on Angular for Google, so thats another thing to keep in mind, though that wouldnt have a huge impact on your decision.
                </p>
                <p>
