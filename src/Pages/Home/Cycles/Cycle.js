...
const Cycle = ({ cycle }) => {
    ...
    const { sellerVarified, productTitle, userName, brand, condition, price, location, registered, usingDuration, sold, picture, _id
    } = cycle;
    ...
    return (
        <div className="card w-full  bg-base-100 shadow-xl">
            ...
            <div className="card-body text-start ">
                ...
                <p>Posted By :{userName} <span className=' rounded-full bg-red-600 text-green-200 p-1'>{sellerVarified ? 'varified' : 'new Seller'}</span> </p>
