...
const AddAPProduct = () => {
    ...
    return (
        <div>
            <form className='grid md:grid-cols-2' onSubmit={handleSubmit(handleAddProduct)}>
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    <select  {...register("catagoryName", {
                        required: "Required",
                    })}
                        className="select select-primary w-full max-w-xs">
                        <option disabled selected value={'Mountain Bike'}>Mountain Bike </option>
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    <input defaultValue={user.displayName} className="input input-bordered w-full max-w-xs"
                        type="text"
                        {...register("userName", {
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    <input defaultValue={user.email} className="input input-bordered w-full max-w-xs"
                        type="email"
                        {...register("email", {
                            required: "Required",
                        })}
                ...
                <button className='btn btn-primary' type="submit"> {loading ? 'uploading' : 'submit'}</button>
            </form>
        </div>
    );
};
